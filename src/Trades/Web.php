...
class Web implements Web_i
{
    ...
    public function getSubDomain($noWWW = true)
    {
		...
		public function httpPost($url, $data) {
          ...
          public static function b64url_encode($data) { //@doc: $data must be already encoded in b64
            return str_replace(['+','/','='], ['-','_',''], $data);
        }
        
        public static function b64url_decode($data) { //@doc: returns b64 ; requires php 7
            return str_replace(['-','_'], ['+','/'], $data);
        }
}
